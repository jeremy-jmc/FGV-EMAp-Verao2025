...
results_loglik <- monte_carlo_dropout_predict(model, x_grid_normalized,1000)
...
g_loglik <- ggplot(df_grid_pred_loglik) +
  ...
  geom_line(aes(x = x_grid, y = pred_mean_loglik), colour = "#D81B60", linewidth = 2) +  # Predicted mean
